...
GO
/*
Тип столбца DeadLine в таблице [dbo].[Tasks] на данный момент -  DATETIMEOFFSET (7) NOT NULL, но будет изменен на  DATETIME2 (0) NOT NULL. Данные могут быть утеряны.

Тип столбца Start в таблице [dbo].[Tasks] на данный момент -  DATETIMEOFFSET (7) NOT NULL, но будет изменен на  DATETIME2 (0) NOT NULL. Данные могут быть утеряны.
*/
